...
import { saveTrainingSession } from '../api/trainingApi'; // Import the Axios function
...
const TrainingSessionScreen = () => {
  ...
  const handleMarkAttendance = async () => {
    ...
    try {
      ...
      await saveTrainingSession(trainingSessionData);
