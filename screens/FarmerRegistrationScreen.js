...
import { registerFarmer } from '../api/farmersApi'; // Adjust the path based on your project structure
  ...
  const handleRegistration = async () => {
    try {
      ...
      if (result.success) {
        ...
        Alert.alert('Success', 'Registration data saved locally and on the server.');
      } else {
        // Display error message
        Alert.alert('Error', result.error || 'Failed to register farmer. Please try again.');
      }
    } catch (error) {
